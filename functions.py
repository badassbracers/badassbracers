...
def insert_food(name: str, price: str, description: str, food_type_id: int, restaurant_id: int):
    global mydb

    mycursor = mydb.cursor()
    sql = "INSERT INTO foods (id, name, price, description, food_type_id, restaurant_id) VALUES(NULL, %s, %s, %s, %s, %s)"
    mycursor.execute(sql, (name, price, description, food_type_id, restaurant_id))
    mydb.commit()
